...
# get the data on modules
  ...
  # get the list of modules in order with their names and activity IDs and record who started or completed each module
    ...
    $args = array( 'post_type' => 'gb_xapi_content', 'category_name' => 'foundations', 'posts_per_page' => 2, 'order' => 'ASC'  );
...
//  d($residents);
  ...
  # add the title
    ...
    $objWorksheet->setCellValue('A1', 'FOUNDATIONS COMPLETION REPORT (' . strtoupper($blockname) . ') - Updated: ' . date("j F Y"));
