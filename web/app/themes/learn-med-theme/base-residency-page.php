  ...
  <div class="wrap container" role="document">
    <div class="content row">
      ...
      <main class="main <?php echo roots_main_class(); ?>" role="main">
        ...
        <div class="btnBackToCourses"><a href="<?php echo site_url(_slug('residency', 'page')); ?>" class="btn btn-primary" ><?php _e("Return to Postgraduate Medical Education ", 'learn.med'); ?></a>
