 ...
 <div class="row">
  ...
  <?php endif; ?>
    ...
    <div class="contentCpd">
      ...
      <p class="mainTextUndergrad "><?php _e('If you are an <span class="boldedCpd">UGME student enrolled in the Global Health Concentration</span>, this is the place to complete your learning objectives as part of the curriculum. ', 'learn.med'); ?></p>
