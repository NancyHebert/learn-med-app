...
<?php if (comments_open()) : ?>
  <section id="respond">
    ...
    <?php else : ?>
      <form action="<?php echo get_option(''); ?>/wp/wp-comments-post.php" method="post" id="commentform">
        <?php if (is_user_logged_in()) : ?>
          <p>

          <!-- /#show user name not login  in the logout link
           ...
           -->
            <?php 
             ...
             _e("Logged in as ", 'learn.med'); 

               printf(__('&nbsp;' .$current_user->user_firstname, 'roots'), get_option('siteurl'), $user_identity);
            ?>
        ...
        <p><input name="submit" class="btn btn-primary" type="submit" id="submit" value="<?php _e('Submit your comment', 'roots'); ?>"></p>
