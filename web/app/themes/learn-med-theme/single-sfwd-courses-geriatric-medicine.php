<?php
/*
Template Name: coursesListGeriatricMedicine
*/
?>
...
<div class="container">
  ...
  <?php while ( have_posts() ) : the_post();  ?>
    ...
    <h2 role="heading" aria-level="2" class="section-header-humanity"><?php the_title(); ?></h2>
  ...
  $args12 = array(
    'post_type' => 'sfwd-courses',
    'post_status' => 'publish',
    'category_name' => _category_slug('medecine_geriatrique'),
    'posts_per_page' => 20,
    );
    //echo _category_slug('medicine_humanity');
  ?>
  ...
  <?php
    ...
    // 'post_type' => 'sfwd-courses',
    // 'post_status' => 'publish',
    // 'category_name' => _category_slug('humanite_medecine'),
    // 'posts_per_page' => 20,
    // );
  ?>
  ...
  ?>
    ...
    {
      $cat = 'medecine_geriatrique';
      //die($cat);
    }
    else
    if ($blog_language == 'en-US')
    {
      $cat = 'geriatric_medicine';
      //die($cat);
    }
    ?>
     ...
     <div class="row filter-desc-number-container col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" >
            <span class="filter-number"><strong>[
              ...
              <?php  
              //echo count( get_posts( $program_query_args ) );
               //_e(' ] program and [ ', 'learn.med');
      ...
      <!-- class="col-lg-5 col-md-5 col-sm-12 col-xs-12" -->
        <section id="courses-list"  class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <a class="btnViewModule" href="<?php the_permalink(); ?> <?php //if ( $blog_language == 'fr-FR' ) {echo '/programme-dorientation-des-nouveaux-membres-du-corps-professoral/';} else { echo '/orientation-new-faculty/'; } ?>" target="_blank">
          ...
          <article class="program-list-course">
            <dl>
              ...
              <button role="button" class="btn btn-humanity  btn-lg  "> <?php _e("View the requirements", 'learn.med'); ?>  </button>
        ...
        ?>
          <article class="courses-list-course" <?php post_class(); ?> >
            <dl>
              ...
              <p class="callToAction"><a role="button" class="btn btn-humanity  btn-lg" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php _e("Learn more about this module", 'learn.med'); ?></a></p>
           <!-- entry-call-to-action -->
