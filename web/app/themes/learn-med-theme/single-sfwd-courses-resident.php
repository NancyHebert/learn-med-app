<?php
/*
Template Name: coursesListResidents
*/
?>
...
<p>Please be patient while the list of modules and programs for Postgraduate Medical Education fully loads; it may take a minute for the full list to display. Note that once the page has loaded you should not have any performance issues while completing the modules.</p>

<h3 role="heading" aria-level="3"><?php _e("List of modules and programs", 'learn.med'); ?></h3>

  <article id="page" >

<?php $args = array( 'post_type' => 'page', 'category_name' => 'residency', 'posts_per_page' => 10 );
      $loop = new WP_Query( $args );

      $args2 = array( 'post_type' => 'sfwd-courses', 'category_name' => 'residency', 'posts_per_page' => 10 );
